...
void gp_screensaver_gen_complete_set_active (
    GpScreensaverGen *object,
    GDBusMethodInvocation *invocation);
...
void gp_screensaver_gen_call_set_active (
    GpScreensaverGen *proxy,
    gboolean arg_value,
    GCancellable *cancellable,
    GAsyncReadyCallback callback,
...
gboolean gp_screensaver_gen_call_set_active_finish (
    GpScreensaverGen *proxy,
    GAsyncResult *res,
    GError **error);

gboolean gp_screensaver_gen_call_set_active_sync (
    GpScreensaverGen *proxy,
    gboolean arg_value,
    GCancellable *cancellable,
    GError **error);
